...
static sNativeMethod gNativeMethods[] = {
    ...
    { "System.pthread_mutex_init(pthread_mutex_t,pthread_mutexattr_t)", "System_pthread_mutex_init", System_pthread_mutex_init },
    ...
    { "System.pthread_mutexattr_init(pthread_mutexattr_t)", "System_pthread_mutexattr_init", System_pthread_mutexattr_init },
    { "System.pthread_mutexattr_settype(pthread_mutexattr_t,int)", "System_pthread_mutexattr_settype", System_pthread_mutexattr_settype },
    { "System.pthread_mutexattr_destroy(pthread_mutexattr_t)", "System_pthread_mutexattr_destroy", System_pthread_mutexattr_destroy },
    { "System.pthread_mutexattr_gettype(pthread_mutexattr_t,pointer)", "System_pthread_mutexattr_gettype", System_pthread_mutexattr_gettype },

    { "System.pthread_cond_init(pthread_cond_t,pthread_condattr_t)", "System_pthread_cond_init", System_pthread_cond_init },
