                             ...
                             sCompileInfo * info)
{
    ...
    {
        append_opecode_to_code(info->code, 7000, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7001, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7002, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7003, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7004, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7005, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7006, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7007, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7008, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7009, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7010, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    ...
    {
        append_opecode_to_code(info->code, 7011, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7012, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7013, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7014, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7015, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7016, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7017, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7018, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7019, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7020, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "Pointer"))
    {
        append_opecode_to_code(info->code, 7021, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7022, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7023, info->no_output);
        *right_type = create_node_type_with_class_name("byte");
    }
                              ...
                              sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7030, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7031, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7036, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7032, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7033, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7034, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7035, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7037, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7038, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7039, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7040, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7041, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7042, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7043, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7044, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7045, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7046, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7047, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7048, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7049, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7050, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "Pointer"))
    {
        append_opecode_to_code(info->code, 7051, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7052, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7053, info->no_output);
        *right_type = create_node_type_with_class_name("short");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                            ...
                            sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7060, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7061, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7062, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7063, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7066, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7064, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7065, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7067, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7068, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7069, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7070, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7071, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7072, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7073, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7074, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7075, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7076, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7077, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7078, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7079, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7080, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "Pointer"))
    {
        append_opecode_to_code(info->code, 7081, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7082, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7083, info->no_output);
        *right_type = create_node_type_with_class_name("int");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                             ...
                             sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7090, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7091, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7092, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7093, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7094, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7095, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7096, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7097, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7098, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7099, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7100, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7101, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7102, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7103, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7104, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7105, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7106, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7107, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7108, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7109, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7110, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "Pointer"))
    {
        append_opecode_to_code(info->code, 7111, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7112, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7113, info->no_output);
        *right_type = create_node_type_with_class_name("long");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                              ...
                              sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7120, info->no_output);
    ...
    {
        append_opecode_to_code(info->code, 7121, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7122, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7123, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7124, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7125, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7126, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7127, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7128, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7129, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7130, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7131, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7132, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7133, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7134, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7135, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7136, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7137, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7138, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7139, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7140, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "Pointer"))
    {
        append_opecode_to_code(info->code, 7141, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7142, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7143, info->no_output);
        *right_type = create_node_type_with_class_name("ubyte");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                               ...
                               sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7150, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7151, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7152, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7153, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7154, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7155, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7156, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7157, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7158, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7159, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7160, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7161, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7162, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7163, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7164, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7165, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7166, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7167, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7168, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7169, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7170, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "Pointer"))
    {
        append_opecode_to_code(info->code, 7171, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7172, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7173, info->no_output);
        *right_type = create_node_type_with_class_name("ushort");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                             ...
                             sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7200, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7201, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7202, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7203, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7204, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7205, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7206, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7207, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7208, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7209, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7210, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7211, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7212, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7213, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7214, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7215, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7216, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7217, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7218, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7219, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7220, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "Pointer"))
    {
        append_opecode_to_code(info->code, 7221, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7222, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7223, info->no_output);
        *right_type = create_node_type_with_class_name("uint");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                              ...
                              sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7230, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7231, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7232, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7233, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7234, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7235, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7236, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7237, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7238, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7239, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7240, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7241, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7242, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7243, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7244, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7245, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7246, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7247, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7248, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7249, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7250, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "Pointer"))
    {
        append_opecode_to_code(info->code, 7251, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7252, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7253, info->no_output);
        *right_type = create_node_type_with_class_name("ulong");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                              ...
                              sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7260, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7261, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7262, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7263, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7264, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7265, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7266, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7267, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7268, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7269, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7270, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7271, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7272, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7273, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7274, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7275, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7276, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7277, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7278, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7279, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7281, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7282, info->no_output);
        *right_type = create_node_type_with_class_name("float");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                               ...
                               sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7290, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7291, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7292, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7293, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7294, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7295, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7296, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7297, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7298, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7299, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7300, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7301, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7302, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7303, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7304, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7305, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7306, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7307, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7308, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7309, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7311, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7312, info->no_output);
        *right_type = create_node_type_with_class_name("double");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                             ...
                             sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7330, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7331, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7332, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7333, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7334, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7335, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7336, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7337, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7338, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7339, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7340, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
    ...
    {
        append_opecode_to_code(info->code, 7341, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "UByte"))
    {
        append_opecode_to_code(info->code, 7342, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "Short"))
    {
        append_opecode_to_code(info->code, 7343, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "UShort"))
    {
        append_opecode_to_code(info->code, 7344, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "Integer"))
    {
        append_opecode_to_code(info->code, 7345, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "UInteger"))
    {
        append_opecode_to_code(info->code, 7346, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "Long"))
    {
        append_opecode_to_code(info->code, 7347, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "ULong"))
    {
        append_opecode_to_code(info->code, 7348, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "Float"))
    {
        append_opecode_to_code(info->code, 7349, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "Double"))
    {
        append_opecode_to_code(info->code, 7350, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "Pointer"))
    {
        append_opecode_to_code(info->code, 7351, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "Char"))
    {
        append_opecode_to_code(info->code, 7352, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "Bool"))
    {
        append_opecode_to_code(info->code, 7353, info->no_output);
        *right_type = create_node_type_with_class_name("char");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                                ...
                                sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7320, info->no_output);
        *right_type = create_node_type_with_class_name("pointer");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7321, info->no_output);
        *right_type = create_node_type_with_class_name("pointer");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7322, info->no_output);
        *right_type = create_node_type_with_class_name("pointer");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7323, info->no_output);
        *right_type = create_node_type_with_class_name("pointer");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7324, info->no_output);
        *right_type = create_node_type_with_class_name("pointer");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7325, info->no_output);
        *right_type = create_node_type_with_class_name("pointer");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7326, info->no_output);
        *right_type = create_node_type_with_class_name("pointer");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7327, info->no_output);
        *right_type = create_node_type_with_class_name("pointer");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7328, info->no_output);
        *right_type = create_node_type_with_class_name("pointer");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
                               ...
                               sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7360, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7364, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7361, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7365, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7362, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7366, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7363, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7367, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7368, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7369, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7373, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7372, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7370, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "regex"))
    {
        append_opecode_to_code(info->code, 7371, info->no_output);
        *right_type = create_node_type_with_class_name("String");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                             ...
                             sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7440, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7441, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7442, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7443, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7444, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7445, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7446, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7447, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7448, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7449, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7450, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7451, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7452, info->no_output);
        *right_type = create_node_type_with_class_name("Byte");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                              ...
                              sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7460, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7461, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7462, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7463, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7464, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7465, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7466, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7467, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7468, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7469, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7470, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7471, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7472, info->no_output);
        *right_type = create_node_type_with_class_name("UByte");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                              ...
                              sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7480, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7481, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7482, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7483, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7484, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7485, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7486, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7487, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7488, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7489, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7490, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7491, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7492, info->no_output);
        *right_type = create_node_type_with_class_name("Short");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                               ...
                               sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7500, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7501, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7502, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7503, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7504, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7505, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7506, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7507, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7508, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7509, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7510, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7511, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7512, info->no_output);
        *right_type = create_node_type_with_class_name("UShort");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                                ...
                                sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7400, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7401, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7402, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7403, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7404, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7405, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7406, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7407, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7408, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7409, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7410, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7411, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7412, info->no_output);
        *right_type = create_node_type_with_class_name("Integer");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                                 ...
                                 sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7420, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7421, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7422, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7423, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7424, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7425, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7426, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7427, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7428, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7429, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7430, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7431, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7432, info->no_output);
        *right_type = create_node_type_with_class_name("UInteger");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                             ...
                             sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7520, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7521, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7522, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7523, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7524, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7525, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7526, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7527, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7528, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7529, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7530, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7531, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7532, info->no_output);
        *right_type = create_node_type_with_class_name("Long");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                              ...
                              sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7540, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7541, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7542, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7543, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7544, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7545, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7546, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7547, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7548, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7549, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7550, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7551, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7552, info->no_output);
        *right_type = create_node_type_with_class_name("ULong");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                              ...
                              sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7560, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7561, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7562, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7563, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7564, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7565, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7566, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7567, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7568, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7569, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7570, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7572, info->no_output);
        *right_type = create_node_type_with_class_name("Float");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                               ...
                               sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7580, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7581, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7582, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7583, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7584, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7585, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7586, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7587, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7588, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7589, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7590, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7592, info->no_output);
        *right_type = create_node_type_with_class_name("Double");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                                ...
                                sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7600, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7601, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7602, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7603, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7604, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7605, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7606, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7607, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7610, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7611, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7612, info->no_output);
        *right_type = create_node_type_with_class_name("Pointer");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                             ...
                             sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7620, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7621, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7622, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7623, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7624, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7625, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7626, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7627, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7628, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7629, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7630, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7631, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7632, info->no_output);
        *right_type = create_node_type_with_class_name("Char");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
                             ...
                             sCompileInfo * info)
{
    if (type_identify_with_class_name(*right_type, "byte"))
    {
        append_opecode_to_code(info->code, 7640, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "ubyte"))
    {
        append_opecode_to_code(info->code, 7641, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "short"))
    {
        append_opecode_to_code(info->code, 7642, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "ushort"))
    {
        append_opecode_to_code(info->code, 7643, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "int"))
    {
        append_opecode_to_code(info->code, 7644, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "uint"))
    {
        append_opecode_to_code(info->code, 7645, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "long"))
    {
        append_opecode_to_code(info->code, 7646, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "ulong"))
    {
        append_opecode_to_code(info->code, 7647, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "float"))
    {
        append_opecode_to_code(info->code, 7648, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "double"))
    {
        append_opecode_to_code(info->code, 7649, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "char"))
    {
        append_opecode_to_code(info->code, 7650, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "pointer"))
    {
        append_opecode_to_code(info->code, 7651, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "bool"))
    {
        append_opecode_to_code(info->code, 7652, info->no_output);
        *right_type = create_node_type_with_class_name("Bool");
    }
    else if (type_identify_with_class_name(*right_type, "Anonymous"))
    {
    ...
    else
    {
        ...
        else if (type_identify_with_class_name(left_type, "Bool"))
        {
            cast_right_type_to_Bool(right_type, info);
                                               ...
                                               "Anonymous") && (*right_type)->mClass->mFlags & 0x1)
        {
