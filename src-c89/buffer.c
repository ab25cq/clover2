...
extern int swscanf(const wchar_t * __restrict __s,
                   const wchar_t * __restrict __format, ...) __attribute__((__nothrow__,__leaf__));
extern int fwscanf(__FILE * __restrict __stream,
                   const wchar_t * __restrict __format, ...) __asm__("__isoc99_fwscanf");
extern int wscanf(const wchar_t * __restrict __format, ...) __asm__("__isoc99_wscanf");
extern int swscanf(const wchar_t * __restrict __s,
                   const wchar_t * __restrict __format, ...) __asm__("__isoc99_swscanf") __attribute__((__nothrow__,__leaf__));
...
extern int vswscanf(const wchar_t * __restrict __s,
                    const wchar_t * __restrict __format,
                    __gnuc_va_list __arg) __asm__("__isoc99_vswscanf") __attribute__((__nothrow__,__leaf__));
...
void sBuf_init(sBuf * self)
{
    self->mBuf = (char *) xmalloc(sizeof(char) * 64);
    self->mSize = 64;
    self->mLen = 0;
    *self->mBuf = '\000';
}
