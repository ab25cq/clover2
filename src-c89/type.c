...
{
    char * class_name;
    class_name = (char *) ((&klass->mConst)->mConst + cl_type->mClassNameOffset);
    return get_class_with_load_and_initialize(class_name);
}
int is_void_type(sCLType * cl_type, sCLClass * klass)
{
    sCLClass * klass2;
    klass2 = get_class_from_cl_type(cl_type, klass);
...
{
    sCLClass * klass2;
    klass2 = get_class_with_load_and_initialize(class_name);
    ;
    return klass == klass2;
}
