...
{
    gSizeGlobalStack = 256;
    gGlobalStack = xcalloc(1, sizeof(CLVALUE) * gSizeGlobalStack);
...
void push_value_to_global_stack(CLVALUE value)
{
    ...
    {
        CLVALUE * global_stack;
        int new_size;
        sCLStack * it;
        global_stack = gGlobalStack;
        new_size = num_global_stack * 2;
        gGlobalStack = xrealloc(gGlobalStack, sizeof(CLVALUE) * new_size);
        memset(gGlobalStack + num_global_stack,
               0,
               new_size - num_global_stack);
...
{
    sCLStack * stack;
    stack = xcalloc(1, sizeof(sCLStack));
