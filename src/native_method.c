...
static sNativeMethod gNativeMethods[] = {
    { "Clover.load(String)", Clover_load },
    ...
    { "System.initialize_string_system()", System_initialize_string_system },
    { "System.initialize_file_system()", System_initialize_file_system },
